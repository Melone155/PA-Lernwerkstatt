    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100/60 to-cyan-100/40">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
                <h1 className="text-3xl font-bold text-purple-700 mb-6 text-center">Registrieren</h1>
                <form className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 pr-10"
                                value={password}
                            ...
                            <button
                                type="button"
                                className="absolute right-2 top-2 text-purple-500 hover:text-purple-700"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-purple-700 mb-1">Passwort wiederholen</label>
                        <div className="relative">
                            <input
                    ...
                    <button
                        type="submit"
                        className="w-full py-2 px-4 bg-purple-500 text-white font-semibold rounded-lg shadow-md transition-colors"
                    >
                        Registrieren
                    </button>
                </form>
                <div className="mt-6 text-center text-sm text-gray-600">
                    Bereits einen Account? <a href="/login" className="text-purple-500 hover:underline font-medium">Login</a>
                </div>
            </div>
        </div>
    )
